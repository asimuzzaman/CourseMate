...
?>
            <form action="/cgpa/edit/" method= "post" id="add_course">
...
?>
              <tr>
                ...
                <td>
                  <form action="/cgpa/edit/?id=<?php echo $row['grade_id']; ?>" method= "post" id="delete_course">
                    <a href="/cgpa/edit/edit.php?id=<?php echo $row['grade_id']; ?>" class="btn btn-success btn-xs">edit</a>
